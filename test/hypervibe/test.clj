...
(deftest one-sample-t-test-test
  (is (= (disc (osmpl {:smpl (array [490 500 530 550 580 590 600 600 650 700]) :hmean 400}))
...
(deftest one-sample-t-test-test-tstat
  (is (= (tstat (disc (osmpl {:smpl (array [490 500 530 550 580 590 600 600 650 700]) :hmean 400})))
         #hypervibe.core.api.test.OneSample{:smpl  #vectorz/vector[490.0 500.0 530.0 550.0 580.0 590.0 600.0 600.0 650.0 700.0],
                                            :hmean 400,
                                            :alpha 0.05,
                                            :smean 579.0,
...
(deftest two-sample-t-test-evariance
  (is (= (disc (evar {:smpls (matrix [ballet-dancers football-players])}))
         #hypervibe.core.api.test.EqualVariance{:smpls  #vectorz/matrix[[89.2 78.2 89.3 88.3 87.3 90.1 95.2 94.3 78.3 89.3]
...
(deftest two-sample-t-test-evariance-tstat
  (is (= (tstat (disc (evar {:smpls (matrix [ballet-dancers football-players])})))
         #hypervibe.core.api.test.EqualVariance{:smpls  #vectorz/matrix [[89.2 78.2 89.3 88.3 87.3 90.1 95.2 94.3 78.3 89.3]
                                                                         [79.3 78.3 85.3 79.3 88.9 91.2 87.2 89.2 93.3 79.9]],
                                                :hmeans [0 0],
                                                :alpha  0.05,
...
(deftest two-sample-t-test-unequal-variance-welch
  (is (= (disc (welch {:smpls (matrix [ballet-dancers football-players])}))
         #hypervibe.core.api.test.Welch{:smpls  #vectorz/matrix [[89.2 78.2 89.3 88.3 87.3 90.1 95.2 94.3 78.3 89.3]
                                                 [79.3 78.3 85.3 79.3 88.9 91.2 87.2 89.2 93.3 79.9]],
                                        :alpha  0.05,
                                        :smeans [87.94999999999999 85.19],
...
(deftest one-sample-conf-inter-test
  (is (= (osc-intvl {:smpl (array population-one) :cval 1.83311293265624 :hmean 400})
